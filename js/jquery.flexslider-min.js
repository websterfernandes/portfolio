                            ...
                            return (
                                ...
                                t.detail === t.MSGESTURE_FLAG_INERTIA
                                    ...
                                    : void (
                                          ...
                                          (t.preventDefault(),
                                          !v && a.transitions && (a.vars.animationLoop || (m = w / ((0 === a.currentSlide && 0 > w) || (a.currentSlide === a.last && w > 0) ? Math.abs(w) / p + 2 : 1)), a.setProps(l + m, "setTouch")))
                                      )
                            );
                        }
                    }
                        ...
                        : ((g = function (t) {
                          ...
                          (h = function (e) {
                              ...
                              (!y || Number(new Date()) - f > t) &&
                                  (e.preventDefault(),
                                  !v && a.transitions && (a.vars.animationLoop || (m /= (0 === a.currentSlide && 0 > m) || (a.currentSlide === a.last && m > 0) ? Math.abs(m) / p + 2 : 1), a.setProps(l + m, "setTouch")));
                          }),
                          (S = function (t) {
